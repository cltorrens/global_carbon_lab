...
###  Comparing two methods for attaining monthly values
Monthly GPP and ER values were calculated two different ways: 1) group by site and month, average all values in a month to get an average daily value for that site and month, then multiply by the # of days in the month;  and 2) take that scaled monthly value and normalize it using the Autotrophy paper's annualized GPP and ER values for each site. Comparison plots for the two methods follow; the dashed red line is the 1:1 line. 
